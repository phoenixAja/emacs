...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-lsp lsp-ui lsp-mode xref-js2 tide pyenv-mode-auto pyenv-mode company-jedi jedi zpresent csv-mode company-anaconda undo-propose auto-org-md cython-mode yaml-mode markdown-mode dockerfile-mode jupyter expand-region dashboard use-package py-autopep8 ob-async material-theme magit gruvbox-theme go-mode flycheck exec-path-from-shell elpygen ein counsel better-defaults)))
